...
input_file_path = "/jet/home/aengel/Paper/HighEntropy/TiVNbTa/DebyeFit/TiVNbTa_input.txt"
...
elements = ["Ti","V", "Nb", "Ta"]  # Elements in the system
numbers = [0.25,0.25,0.25,0.25]  # Specify the number of atoms corresponding to the elements

# Define the range of lattice constants and step size
lattice_constants = np.arange(5.50, 7.00, 0.10)

# Provide the path to the parent directory containing the {system} directory
base_path = "/jet/home/aengel/Paper/HighEntropy/TiVNbTa/DebyeFit/"
...
for lattice_constant in lattice_constants:
    ...
    if variation:
        k_file = f"{base_path}{variation}/{lattice_constant:.2f}/k_n0000000_{system}"
        o_file = f"{base_path}{variation}/{lattice_constant:.2f}/o_n0000000_{system}"
    else:
        k_file = f"{base_path}{lattice_constant:.2f}/k_n0000000_{system}"
        o_file = f"{base_path}{lattice_constant:.2f}/o_n0000000_{system}"
