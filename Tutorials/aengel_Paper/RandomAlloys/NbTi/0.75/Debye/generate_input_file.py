...
input_file_path = "/jet/home/aengel/Paper/RandomAlloys/NbTi/0.75/Debye/NbTi_input.txt"
...
numbers = [0.25,0.75]  # Specify the number of atoms corresponding to the elements

# Define the range of lattice constants and step size
lattice_constants = np.arange(5.40, 7.00, 0.10)

# Provide the path to the parent directory containing the {system} directory
base_path = "/jet/home/aengel/Paper/RandomAlloys/NbTi/0.75/Debye/"
