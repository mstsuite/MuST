...
input_file_path = "/jet/home/aengel/Paper/RandomAlloys/NbTi/0.40/Debye/NbTi_input.txt"
...
elements = ["Nb","Ti"]  # Elements in the system
numbers = [0.60,0.40]  # Specify the number of atoms corresponding to the elements

# Define the range of lattice constants and step size
lattice_constants = np.arange(5.00, 7.00, 0.10)

# Provide the path to the parent directory containing the {system} directory
base_path = "/jet/home/aengel/Paper/RandomAlloys/NbTi/0.40/Debye/"
