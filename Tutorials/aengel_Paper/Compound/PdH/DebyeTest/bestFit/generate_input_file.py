...
input_file_path = "/jet/home/aengel/Paper/Compound/PdH/DebyeTest/bestFit/PdH_input.txt"
...
elements = ["Pd","H"]  # Elements in the system
numbers = [0.5,0.5]  # Specify the number of atoms corresponding to the elements

# Define the range of lattice constants and step size
lattice_constants = np.arange(6.50, 8.50, 0.10)

# Provide the path to the parent directory containing the {system} directory
base_path = "/jet/home/aengel/Paper/Compound/PdH/DebyeTest/bestFit/"
