...
# input_file_path = "/path/to/data.txt"
# output_plot_path = "/path/to/output_plot.png"
# output_file_path = "/path/to/output_values.txt"
...
numbers = list(map(int, system_data.get('Numbers', '').split()))
